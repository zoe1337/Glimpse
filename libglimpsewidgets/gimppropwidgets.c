 ...
 *
 * Return value: A #libglimpsewidgets-gimpenumstockbox containing the radio buttons.
 *
 * Since: 2.4
 *
 * Deprecated: 2.10
 ...
 *
 * Return value: A #libglimpsewidgets-gimpenumiconbox containing the radio buttons.
 *
 * Since: 2.10
 */
GtkWidget *
 ...
 *
 * Return value: A new #libglimpsewidgets-gimpspinbutton.
 *
 * Since: 2.4
 */
GtkWidget *
 ...
 *
 * Creates a #libglimpsewidgets-gimpscaleentry (slider and spin button)
                                ...
                                GObject       *config)
{
  ...
  if (max_len > 0 && g_utf8_strlen (text, -1) > max_len)
    {
      g_message (dngettext (GETTEXT_PACKAGE "-libglimpse",
