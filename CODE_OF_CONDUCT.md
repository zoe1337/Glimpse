...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by contacting any member of the project leadership (sometimes called “the governing team”) on Matrix: [TrechNex](https://matrix.to/#/@treacherousnexus:matrix.org), [BrainBlasted](https://matrix.to/#/@brainblasted:disroot.org), [Clipsey](https://matrix.to/#/@clipsey:matrix.org).
