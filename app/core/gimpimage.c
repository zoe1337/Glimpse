  ...
  if (gimp_object_get_memsize (GIMP_OBJECT (image), NULL) >= ((gint64) 1 << 32))
    {
      ADD_REASON (g_strdup_printf (_("Support for image files larger than "
                                     "4GB was added in %s"), "GNU I.M.P 2.10"));
...
#undef ADD_REASON
  ...
  switch (version)
    ...
    case 2:
      ...
      if (version_string) *version_string = "GNU I.M.P 2.6";
      break;

    case 3:
      if (gimp_version)   *gimp_version   = 208;
      if (version_string) *version_string = "GNU I.M.P 2.8";
      break;
    ...
    case 13:
      ...
      if (version_string) *version_string = "GNU I.M.P 2.10";
      break;
    }
