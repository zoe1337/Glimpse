 ...
 * @short_description: Utility functions provided and used by libglimpsethumb
 *
 * Utility functions provided and used by libglimpsethumb
 **/
 ...
 * before any other functions from libglimpsethumb are used. You may call
 ...
 * library. Apart from this function, libglimpsethumb is multi-thread
 * safe.
 *
 ...
 * defined in the spec. If you wish to use libglimpsethumb to store
