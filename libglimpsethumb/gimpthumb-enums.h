 ...
 * @short_description: Enumerations used by libglimpsethumb
 *
 * Enumerations used by libglimpsethumb
 **/
 ...
 *
 * Possible image and thumbnail file states used by libglimpsethumb.
 **/
